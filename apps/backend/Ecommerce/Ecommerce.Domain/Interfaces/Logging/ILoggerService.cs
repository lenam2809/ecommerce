namespace Ecommerce.Domain.Interfaces.Logging
{
    ...
    public interface ISeriLogger
    {
        ...
        void LogInformation(string messageTemplate, IReadOnlyDictionary<string, object?>? properties = null);
        ...
        void LogWarning(string messageTemplate, IReadOnlyDictionary<string, object?>? properties = null);
        ...
        void LogDebug(string messageTemplate, IReadOnlyDictionary<string, object?>? properties = null);

        /// <summary>
        /// Ghi log lỗi, dùng khi xảy ra lỗi cần được theo dõi và xử lý.
        /// </summary>
        /// <param name="message">Thông điệp lỗi cần ghi log.</param>
        void LogError(string messageTemplate, IReadOnlyDictionary<string, object?>? properties = null);
        ...
        void LogError(Exception exception, string messageTemplate, IReadOnlyDictionary<string, object?>? properties = null);
    }
